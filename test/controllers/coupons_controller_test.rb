...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference("Coupon.count") do
      post coupons_url, params: { coupon: { description: @coupon.description, status: @coupon.status, subject: @coupon.subject, type: @coupon.type } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { description: @coupon.description, status: @coupon.status, subject: @coupon.subject, type: @coupon.type } }
